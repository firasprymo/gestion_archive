...
@Component({
    ...
    templateUrl: './request-versement-document-deuxieme.component.html',
    styles: [
        /* language=SCSS */
        `
            .inventory-grid {
...
export class RequestVersementDocumentDeuxiemeComponent implements OnInit, AfterViewInit, OnDestroy {
