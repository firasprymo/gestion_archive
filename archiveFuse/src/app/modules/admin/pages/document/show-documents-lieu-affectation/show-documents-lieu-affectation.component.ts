...
@Component({
    ...
    templateUrl: './show-documents-lieu-affectation.component.html',
    styles: [
        /* language=SCSS */
        `
            .inventory-grid {
...
export class ShowDocumentsLieuAffectationComponent implements OnInit, AfterViewInit, OnDestroy {
