...
@Component({
    ...
    templateUrl: './request-versement-document-troisieme.component.html',
    styles: [
        /* language=SCSS */
        `
            .inventory-grid {
...
export class RequestVersementDocumentTroisiemeComponent implements OnInit, AfterViewInit, OnDestroy {
