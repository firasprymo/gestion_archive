...
import { InventoryBrand, InventoryCategory, InventoryPagination, InventoryVendor } from 'app/modules/admin/apps/ecommerce/inventory/inventory.types';
...
export class ShowStructureCentralComponent implements OnInit, AfterViewInit, OnDestroy {
...
selectedStuctureCentral: StructureCentral | null = null;
...
ngOnInit(): void {
    ...
    // Get the pagination
    this._structureCentralService.pagination$
    ...
    this.searchInputControl.valueChanges
        .pipe(
            ...
            switchMap((query) => {
                ...
                this.closeDetails();
                this.isLoading = true;
                return this._structureCentralService.getAllStructureCentrals(0, 10, 'name', 'asc', query);
            }),
            map(() => {
    ...
    if (this._sort && this._paginator) {
        ...
        merge(this._sort.sortChange, this._paginator.page).pipe(
            switchMap(() => {
                this.closeDetails();
                this.isLoading = true;
                return this._structureCentralService.getAllStructureCentrals(this._paginator.pageIndex, this._paginator.pageSize, this._sort.active, this._sort.direction);
            }),
            map(() => {
                this.isLoading = false;
            })
 ...
 */
closeDetails(): void {
    this.selectedStuctureCentral = null;
}
...
deleteSelectedStructureCentral(structureCentral: StructureCentral): void {
